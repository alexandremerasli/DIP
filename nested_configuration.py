...
def config_func():
    ...
    hyperparameters_config = {
        ...
        "nb_inner_iteration" : tune.grid_search([2]), # Number of inner iterations in ADMMLim (if mlem_sequence is False) or in OPTITR (for Gong)
...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        #"lr" : tune.grid_search([0.01,0.05]), # Learning rate in network optimization
        ...
        "k_DD" : tune.grid_search([32]), # k for Deep Decoder
        ## ADMMLim - OPTITR hyperparameters
        "nb_inner_iteration" : tune.grid_search([10]), # Number of inner iterations in ADMMLim (if mlem_sequence is False) or in OPTITR (for Gong)
        "nb_outer_iteration": tune.grid_search([10]), # Number outer iterations in ADMMLim
