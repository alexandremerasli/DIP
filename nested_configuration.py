...
# Configuration dictionnary for general settings parameters (not hyperparameters)
    ...
    fixed_config = {
        ...
        "unnested_1st_global_iter" : tune.grid_search([True]), # If True, unnested are computed after 1st global iteration (because rho is set to 0). If False, initialize f as MLEM 60 it hard coded almost as in Gong paper, and rho is not changed.
