...
nb_computation = 5
config_files = 2*nb_computation*['nested_MIC_brain_2D_diff5','nested_MIC_brain_2D_diff5_SC2','nested_MIC_brain_2D_diff5_SC1']#,'nested_MIC_brain_2D_diff1']
# config_files = 2*nb_computation*['nested_MIC_brain_2D_diff1']
config_files = 2*nb_computation*['nested_MIC_brain_2D_diff5'] #,'nested_MIC_brain_2D_diff1']
...
for lib_string in config_files:
    if (i>=nb_computation): # Restart count for new setting
        ...
        num_meth +=1
    if (i > -1):
        os.system("mv /home/meraslia/workspace_reco/nested_admm/data/Algo/image50_1 /disk/workspace_reco/nested_admm/data/Algo/image50_1_" + config_files[i] + str(i))
    i+=1
    try:
    # if (True):
