    ...
    def marker_color_dict_method(self):
        if (self.phantom == "image2_0"):
            ...
            color_dict_add_tests = {
                ...
                "files_TMI_revision__high_count__normalization__nested" : ["blue"],
        ...
        if (self.phantom == "image2_0"):                    
            ...
            marker_dict_supp = {
                ...
                "configuration_files_TMI_revision__high_count__normalization__DIPRecon" : ["x"],
                "files_TMI_revision__high_count__normalization__nested" : ["x"],
                "configuration_files_TMI_revision__high_count__normalization__DNA_ReLU__patience200" : ["x"],
                "configuration_files_TMI_revision__high_count__normalization__DNA_ReLU__patience500" : ["x"],
                "configuration_files_TMI_revision__high_count__positive_norm__DIPRecon" : ["x"],
                "configuration_files_TMI_revision__high_count__positive_norm__DNA" : ["x"],
                "configuration_files_TMI_revision__high_count__positive_norm__DNA_ReLU__patience200" : ["x"],
                "configuration_files_TMI_revision__high_count__positive_norm__DNA_ReLU__patience500" : ["x"],
                "configuration_files_TMI_revision__high_count__standardization__DIPRecon" : ["x"],
                "configuration_files_TMI_revision__high_count__standardization__DNA" : ["x"],
                "configuration_files_TMI_revision__high_count__standardization__DNA_ReLU" : ["x"],
                "configuration_files_TMI_revision__low_count__normalization__DIPRecon" : ["x"],
                "configuration_files_TMI_revision__low_count__normalization__DNA" : ["x"],
                "configuration_files_TMI_revision__low_count__normalization__DNA_ReLU" : ["x"],
                "configuration_files_TMI_revision__low_count__positive_norm__DIPRecon" : ["x"],
                "configuration_files_TMI_revision__low_count__positive_norm__DNA" : ["x"],
                "configuration_files_TMI_revision__low_count__positive_norm__DNA_ReLU" : ["x"],
                #####################
