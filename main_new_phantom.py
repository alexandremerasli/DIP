...
settings_config = {
    ...
    "nb_threads" : tune.grid_search([0]), # Number of desired threads. 0 means all the available threads
    ...
    "replicates" : tune.grid_search(list(range(41,41+1))), # List of desired replicates. list(range(1,n+1)) means n replicates
