...
nb_counts=10000000 # FDG MIC statistics
...
for ((replicate_id=1;replicate_id<=nb_replicates;replicate_id++)); do
    ...
    SMprojector.exe -m mmr2d -c cmap0/cmap0.ecm -i image50_1.hdr -a image50_1_atn.hdr -s 0.35 -r $random_fraction -l 0.01 -p 4. -v 5 -P $nb_counts -o simu0_${replicate_id} -D
    ...
    SMmaker.exe -m mmr2d -o data50_1_${replicate_id} -p simu0_${replicate_id}/simu0_${replicate_id}_pt.s.hdr -r simu0_${replicate_id}/simu0_${replicate_id}_rd.s.hdr -s simu0_${replicate_id}/simu0_${replicate_id}_sc.s.hdr -n simu0_${replicate_id}/simu0_${replicate_id}_nm.s.hdr -A simu0_${replicate_id}/simu0_${replicate_id}_at.s -c cmap0/cmap0.ecm -castor -v 2
