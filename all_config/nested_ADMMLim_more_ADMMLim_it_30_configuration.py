...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "mu_DIP" : tune.grid_search([333]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMLim
        ...
        "nb_outer_iteration": tune.grid_search([100]), # Number of outer iterations in ADMMLim (and nested) and OPTITR (for Gong)
