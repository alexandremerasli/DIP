...
def config_func_MIC():
    ...
    settings_config = {
        ...
        "castor_foms" : tune.grid_search([False]), # Set to True to compute CASToR Figure Of Merits (likelihood, residuals for ADMMLim)
    }
    ...
    fixed_config = {
        ...
        "nb_subsets" : tune.grid_search([8]), # Number of subsets in chosen reconstruction algorithm (automatically set to 1 for ADMMLim)
