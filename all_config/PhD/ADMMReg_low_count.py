...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "sub_iter_DIP_init" : tune.grid_search([10]), # Number of DIP iterations at DNA/DIPRecon initialization. Could be overrided if early stopping point is reached using "DIP_early_stopping_when" parameter
