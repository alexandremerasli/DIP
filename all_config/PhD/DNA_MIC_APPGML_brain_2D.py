...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "sub_iter_DIP_initial_and_final" : tune.grid_search([200]), # Number of epochs in first global iteration (pre iteraiton) in network optimization (only for DIPRecon for now)
