...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "sub_iter_DIP" : tune.grid_search([400]), # Number of epochs in network optimization
        ...
        "diffusion_model_like_each_DIP" : tune.grid_search([0.01,0.03]), # Number of skip connections in DIP architecture (0, 1, 2, 3)
        "diffusion_model_like_each_DIP" : tune.grid_search([0]), # Number of skip connections in DIP architecture (0, 1, 2, 3)
