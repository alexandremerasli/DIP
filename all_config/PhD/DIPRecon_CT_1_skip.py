...
def config_func_MIC():
    ...
    fixed_config = {
        "max_iter" : tune.grid_search([499]), # Number of iterations for usual optimizers (MLEM, BSREM, AML etc.) and outer iterations for DNA and DIPRecon
    ...
    hyperparameters_config = {
        ...
        #"image_init_path_without_extension" : tune.grid_search(['MLEM_it60','BSREM_it30']), # Initial image of the reconstruction algorithm (taken from subroot + "/Data/initialization")
