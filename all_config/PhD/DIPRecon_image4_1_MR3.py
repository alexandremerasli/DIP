...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "windowSize" : tune.grid_search([10,50,100,500]), # Neural Network (NN) architecture to use ("DIP" (U-Net from DIPRecon paper), "DD" (Deep Decoder"), "DD_AE" (DD based autoencoder), "DIP_VAE" (DIP-based Variational AutoEncoder)))
    ...
    hyperparameters_config = {
        ...
        "mu_DIP" : tune.grid_search([20]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
