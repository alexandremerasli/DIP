...
def config_func_MIC():
    ...
    fixed_config = {
        "max_iter" : tune.grid_search([5]), # Number of iterations for usual optimizers (MLEM, BSREM, AML etc.) and outer iterations for DNA and DIPRecon
    ...
    hyperparameters_config = {
        ...
        "mu_DIP" : tune.grid_search([10.13123]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
