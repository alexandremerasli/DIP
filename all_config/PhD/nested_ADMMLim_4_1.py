...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "image_init_path_without_extension" : tune.grid_search(['ADMMLim_it300']), # Initial image of the reconstruction algorithm (taken from data/algo/Data/initialization)
