...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "rho" : tune.grid_search([3,0.3,0.03,3e-5]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (nested and Gong)
        ...
        "rho" : tune.grid_search([0.03,3e-8]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (nested and Gong)
        "rho" : tune.grid_search([3,0.3,0.03,3e-5]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (nested and Gong)
