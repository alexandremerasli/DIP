...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "sub_iter_DIP" : tune.grid_search([40]), # Number of epochs in network optimization
        ...
        "nb_inner_iteration": tune.grid_search([5]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
