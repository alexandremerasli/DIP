...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "sub_iter_DIP_initial_and_final" : tune.grid_search([400]), # Number of DIP iterations at DNA/DIPRecon initialization. Could be overrided if early stopping point is reached using "DIP_early_stopping_when" parameter
        ...
        "patienceNumber" : tune.grid_search([40]), # Network to use (DIP,DD,DD_AE,DIP_VAE)
    }
