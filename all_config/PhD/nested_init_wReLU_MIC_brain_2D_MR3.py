...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "nb_outer_iteration": tune.grid_search([2,10]), # Number of outer iterations in ADMMLim (and DNA) and OPTITR (for DIPRecon)
        "nb_outer_iteration": tune.grid_search([10,30,100]), # Number of outer iterations in ADMMLim (and DNA) and OPTITR (for DIPRecon)
        "nb_outer_iteration": tune.grid_search([10,30,100]), # Number of outer iterations in ADMMLim (and DNA) and OPTITR (for DIPRecon)
        "nb_outer_iteration": tune.grid_search([10,30]), # Number of outer iterations in ADMMLim (and DNA) and OPTITR (for DIPRecon)
        "nb_outer_iteration": tune.grid_search([1,10,30]), # Number of outer iterations in ADMMLim (and DNA) and OPTITR (for DIPRecon)
