...
def config_func_MIC():
    ...
    fixed_config = {
        "max_iter" : tune.grid_search([36]), # Number of global iterations for usual optimizers (MLEM, BSREM, AML etc.) and for DNA and DIPRecon
    ...
    hyperparameters_config = {
        ...
        "post_smoothing" : tune.grid_search([3,4,5,6]), # Post smoothing by CASToR after reconstruction
