...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "sub_iter_DIP_initial_and_final" : tune.grid_search([400]), # Number of epochs in first global iteration (pre iteraiton) in network optimization (only for Gong for now)
    ...
    hyperparameters_config = {
        ...
        "rho" : tune.grid_search([3,0.3,0.03,0.003]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (nested and Gong)
