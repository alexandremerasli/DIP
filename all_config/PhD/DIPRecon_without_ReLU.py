...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "mu_DIP" : tune.grid_search([1851221]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
        "tau_DIP" : tune.grid_search([1851221]), # Factor to multiply alpha in adaptive alpha computation in ADMMReg. If adaptive tau, it corresponds to tau max
