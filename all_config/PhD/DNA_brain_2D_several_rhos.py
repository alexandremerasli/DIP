...
def config_func_MIC():
    ...
    fixed_config = {
        "max_iter" : tune.grid_search([300]), # Number of iterations for usual optimizers (MLEM, BSREM, AML etc.) and outer iterations for DNA and DIPRecon
    ...
    hyperparameters_config = {
        ...
        "rho" : tune.grid_search([3,0.3,0.03,3e-4,3e-5]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
        "rho" : tune.grid_search([3,0.3,0.03,3e-5]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
        ...
        "rho" : tune.grid_search([0.03,3e-8]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
        "rho" : tune.grid_search([3,0.3,0.03,3e-5]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
        ...
        "nb_inner_iteration": tune.grid_search([1]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
        # "nb_inner_iteration": tune.grid_search([3]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
