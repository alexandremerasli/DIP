...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "mu_DIP" : tune.grid_search([1200]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
        ...
        "lr" : tune.grid_search([0.001,0.005,0.05,0.1,0.5,1,5]), # Learning rate in network optimization
        "lr" : tune.grid_search([0.01,0.1,1,5]), # Learning rate in network optimization
        "lr" : tune.grid_search([0.1,5]), # Learning rate in network optimization
