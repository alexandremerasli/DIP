...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "scaling" : tune.grid_search(['standardization','normalization','positive_normalization','nothing','normalization_init']), # Pre processing of neural network input (nothing, uniform, normalization, standardization)
