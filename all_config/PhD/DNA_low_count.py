...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "rho" : tune.grid_search([3,0.03,0.0003]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
        ...
        "nb_inner_iteration": tune.grid_search([3,10,30]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
