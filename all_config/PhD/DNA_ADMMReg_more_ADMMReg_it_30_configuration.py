...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        # "alpha_EMV" : tune.grid_search([0.1]), # EMV forgetting factor alpha
        # "alpha_EMV" : tune.grid_search([0.9]), # EMV forgetting factor alpha
    ...
    hyperparameters_config = {
        ...
        "rho" : tune.grid_search([0.8,0.3,0.08]), # Penalty strength (beta) in PLL algorithms, ADMM penalty parameter (DNA and DIPRecon)
