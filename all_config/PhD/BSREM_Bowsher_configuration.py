...
def config_func_MIC():
    ...
    fixed_config = {
        ...
        "windowSize" : tune.grid_search([50]), # Neural Network (NN) architecture to use ("DIP" (U-Net from DIPRecon paper), "DD" (Deep Decoder"), "DD_AE" (DD based autoencoder), "DIP_VAE" (DIP-based Variational AutoEncoder)))
