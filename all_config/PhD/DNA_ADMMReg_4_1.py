...
def config_func_MIC():
    ...
    hyperparameters_config = {
        ...
        "image_init_path_without_extension" : tune.grid_search(['MLEM_it60','ADMMReg_it300','OSEM_it36']), # Initial image of the reconstruction algorithm (taken from subroot + "/Data/initialization")
        "image_init_path_without_extension" : tune.grid_search(['ADMMReg_it300']), # Initial image of the reconstruction algorithm (taken from subroot + "/Data/initialization")
