...
def config_func_MIC():
    ...
    fixed_config = {
        "max_iter" : tune.grid_search([450]), # Number of iterations for usual optimizers (MLEM, BSREM, AML etc.) and outer iterations for DNA and DIPRecon
    ...
    hyperparameters_config = {
        ...
        "end_to_end" : tune.grid_search([True]), # Initial image of the reconstruction algorithm (taken from subroot + "/Data/initialization")
