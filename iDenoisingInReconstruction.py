...
class iDenoisingInReconstruction(vDenoising):
    def __init__(self,config,root,admm_it):
    ...
    def initializeSpecific(self, hyperparameters_config, root):
        ...
        self.net_outputs_path = self.subroot+'Block2/out_cnn/' + format(self.test) + '/out_' + self.net + '' + format(self.admm_it) + suffix_func(hyperparameters_config) + '.img'
