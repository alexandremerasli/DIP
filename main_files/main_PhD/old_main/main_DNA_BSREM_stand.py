...
settings_config = {
    "image" : tune.grid_search(['image4000_0']), # Image from database (data/Algo/Data/database_v2)
    ...
    "replicates" : tune.grid_search(list(range(1,10+1))), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
