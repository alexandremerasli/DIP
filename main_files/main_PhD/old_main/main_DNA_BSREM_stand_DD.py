...
settings_config = {
    ...
    #"replicates" : tune.grid_search([2,3,5,7,10,11,12,13,14,16,17,18,19,20,21,23,24,26,27,28,29,33,35,37,38,39,40]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
fixed_config = {
    ...
    "net" : tune.grid_search(['DD']), # Neural Network (NN) architecture to use ("DIP" (U-Net from DIPRecon paper), "DD" (Deep Decoder"), "DD_AE" (DD based autoencoder), "DIP_VAE" (DIP-based Variational AutoEncoder)))
