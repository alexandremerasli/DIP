...
settings_config = {
    ...
    #"replicates" : tune.grid_search([9,13,22,25,28,32]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
fixed_config = {
    ...
    "nb_subsets" : tune.grid_search([14]), # Number of subsets in chosen reconstruction algorithm (automatically set to 1 for ADMMReg)
...
hyperparameters_config = {
    ...
    "mu_DIP" : tune.grid_search([14]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
