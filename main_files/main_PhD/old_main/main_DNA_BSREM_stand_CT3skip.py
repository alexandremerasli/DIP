...
settings_config = {
    ...
    #"replicates" : tune.grid_search([4,11,15,17,23,32,33,35]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
    ...
    # "replicates" : tune.grid_search([25,41]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
    #"replicates" : tune.grid_search(list(range(1,2+1))), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
