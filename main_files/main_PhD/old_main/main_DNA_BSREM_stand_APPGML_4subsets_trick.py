...
fixed_config = {
    ...
    "nb_subsets" : tune.grid_search([4]), # Number of subsets in chosen reconstruction algorithm (automatically set to 1 for ADMMLim)
...
hyperparameters_config = {
    ...
    "mu_DIP" : tune.grid_search([4]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMLim
