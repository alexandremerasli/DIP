...
settings_config = {
    ...
    #"replicates" : tune.grid_search([4,11,34]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
fixed_config = {
    ...
    "nb_subsets" : tune.grid_search([4]), # Number of subsets in chosen reconstruction algorithm (automatically set to 1 for ADMMReg)
...
hyperparameters_config = {
    ...
    "mu_DIP" : tune.grid_search([4]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
