...
settings_config = {
    ...
    "method" : tune.grid_search(['APPGML','BSREM',"DNA"]), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
...
fixed_config = {
    "max_iter" : tune.grid_search([15]), # Number of iterations for usual optimizers (MLEM, BSREM, AML etc.) and outer iterations for DNA and DIPRecon
...
hyperparameters_config = {
    ...
    "nb_inner_iteration": tune.grid_search([300]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
