...
settings_config = {
    ...
    "replicates" : tune.grid_search(list(range(65,100+1))), # List of desired replicates. list(range(1,n+1)) means n replicates
    ...
    "image_init_path_without_extension" : tune.grid_search(['ADMMLim_it100']), # Initial image of the reconstruction algorithm (taken from subroot + "/Data/initialization")
}
