...
settings_config = {
    ...
    "method" : tune.grid_search(['DIPRecon_ADMMLim_stand','DIPRecon_ADMMLim_norm','DIPRecon_BSREM_stand','DIPRecon_MLEM_norm',"DNA_ADMMLim_stand","DNA_BSREM_stand"]), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
    #"method" : tune.grid_search(["DNA_ADMMLim_stand","DNA_BSREM_stand"]), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
    ...
    "method" : tune.grid_search(['DIPRecon_MLEM_norm','DIPRecon_ADMMLim_norm','DIPRecon_ADMMLim_stand','DIPRecon_BSREM_stand',"DNA_BSREM_stand","DNA_ADMMLim_stand"]),
    #"method" : tune.grid_search(["DNA","DIPRecon",'ADMMLim','APGMAP','BSREM','OSEM']), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
    #"method" : tune.grid_search(['ADMMLim','APGMAP']), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
