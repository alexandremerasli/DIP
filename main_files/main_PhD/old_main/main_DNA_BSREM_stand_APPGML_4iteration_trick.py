...
settings_config = {
    ...
    "replicates" : tune.grid_search([3,12,14,19,22,27,28,29,30,39]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
hyperparameters_config = {
    ...
    "tau_DIP" : tune.grid_search([4]), # Factor to multiply alpha in adaptive alpha computation in ADMMReg. If adaptive tau, it corresponds to tau max
    ...
    "nb_inner_iteration": tune.grid_search([4]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
