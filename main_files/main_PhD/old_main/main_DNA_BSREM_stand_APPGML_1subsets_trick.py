...
settings_config = {
    ...
    #"replicates" : tune.grid_search([8,15,38,39,46,50,54,56,63]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
hyperparameters_config = {
    ...
    "mu_DIP" : tune.grid_search([1]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMReg
