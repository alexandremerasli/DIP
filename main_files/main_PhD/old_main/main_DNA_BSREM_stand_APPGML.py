...
settings_config = {
    ...
    "replicates" : tune.grid_search([26]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
    "replicates" : tune.grid_search([35,36,37,38,39,40]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
