...
settings_config = {
    ...
    #"replicates" : tune.grid_search([17,18,26,37]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
    #"replicates" : tune.grid_search([6,7,14]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
hyperparameters_config = {
    ...
    "nb_inner_iteration": tune.grid_search([80]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
