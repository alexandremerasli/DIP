...
settings_config = {
    ...
    "replicates" : tune.grid_search([6,7,17,18,20,26,28,32,34,38]), # List of desired replicates to work with in parallel. list(range(1,n+1)) means n replicates
...
hyperparameters_config = {
    ...
    "tau_DIP" : tune.grid_search([28]), # Factor to multiply alpha in adaptive alpha computation in ADMMReg. If adaptive tau, it corresponds to tau max
    ...
    "nb_inner_iteration": tune.grid_search([28]), # Number of inner iterations in DNA and DIPRecon (respectively number of iterations of ADMM-Reg and OPTITR)
