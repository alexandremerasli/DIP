...
fixed_config = {
    "max_iter" : tune.grid_search([10]), # Number of global iterations for usual optimizers (MLEM, BSREM, AML etc.) and for DNA and DIPRecon
...
hyperparameters_config = {
    ...
    "nb_outer_iteration": tune.grid_search([3000]), # Number of outer iterations in ADMMReg (and DNA) and OPTITR (for DIPRecon)
