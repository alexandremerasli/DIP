...
settings_config = {
    ...
    #"replicates" : tune.grid_search([2,3,4,5,8,9,12,13,14,15,16,17,18,19,20,22,24,27,29,34,36,37,39]), # List of desired replicates. list(range(1,n+1)) means n replicates
    #"replicates" : tune.grid_search([8,28,31,32,35,36]), # List of desired replicates. list(range(1,n+1)) means n replicates
