...
def class_for_task(config,task):
    ...
    elif (task == 'end_to_end'): # Run network denoising after a given reconstructed image im_corrupt
        from iEndToEnd import iEndToEnd
        classTask = iEndToEnd(config)
