...
# TMI paper
nb_computation = 4
# config_files = nb_computation*['DIPRecon_initDNA_MIC_brain_2D_MR3','DIPRecon_skip3_3_my_settings','DIPRecon_initDNA_skip3_3_my_settings']
# config_files = ['DIPRecon_initDNA_skip3_3_my_settings']
# config_files = ['DIPRecon_initDNA_MIC_brain_2D_MR3']
# config_files = ['DIPRecon_MIC_brain_2D_MR3']
# config_files = ['DIPRecon_skip3_3_my_settings',"DNA_ADMMReg_more_ADMMReg_it_10_configuration']
...
config_files = (nb_computation-1)*['DIPRecon_MIC_brain_2D_MR3']
config_files += nb_computation*["DNA_MIC_brain_2D_MR3"]

# config_files = nb_computation*['BSREM_Bowsher_configuration']
# # config_files = ["DNA_image4_1_MR3"]
# config_files = ["DIPRecon_image4_1_MR3"]

# config_files = ['ADMMReg_Bowsher_configuration']
# config_files = ['APPGML_Bowsher_configuration']

# config_files = (nb_computation-1)*['APPGML_configuration']
# config_files = nb_computation*['APPGML_configuration']
# # config_files = ['APPGML_configuration']
# # config_files = nb_computation*['ADMMReg_configuration']
# # config_files = (nb_computation-1)*['ADMMReg_configuration']
config_files = ['ADMMReg_configuration']
