...
settings_config = {
    ...
    "method" : tune.grid_search(["DNA_ADMMLim_more_ADMMLim_it_10',"DNA_APPGML_1it','DIPRecon_skip3_3_my_settings','DIPRecon_CT_1_skip']), # Reconstruction algorithm (DNA, DIPRecon, or algorithms from CASToR (MLEM, BSREM, AML, etc.))
