...
fixed_config = {
    "max_iter" : tune.grid_search([3]), # Number of global iterations for usual optimizers (MLEM, BSREM, AML etc.) and for DNA and DIPRecon
...
hyperparameters_config = {
    ...
    "mu_DIP" : tune.grid_search([120]), # Factor to balance primal and dual residual in adaptive alpha computation in ADMMLim
    "tau_DIP" : tune.grid_search([1.5]), # Factor to multiply alpha in adaptive alpha computation in ADMMLim. If adaptive tau, it corresponds to tau max
