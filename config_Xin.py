...
hyperparameters_config = {
    ...
    "sub_iter_DIP" : 200, # Number of epochs in network optimization
...
config_tune = {**settings_config, **fixed_config, **hyperparameters_config, **split_config}