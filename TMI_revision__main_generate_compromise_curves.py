...
settings_config = {
    "image" : tune.grid_search(['image50_2']), # HIGH STAT
    #"image" : tune.grid_search(['image50_2_10']), # LOW STAT
...
#                                   'configuration_files_TMI_revision__high_count__normalization__Gong',
                                   'files_TMI_revision__high_count__normalization__nested',
...
if (task != "post_reco"):
    ...
    from TMI_revision__main_generate_compromise_curves_bis import iFinalCurves
