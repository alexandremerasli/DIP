for ((phantom_type=1;phantom_type<=4;phantom_type++)); do
    for num_epoch in {1000,4000,7500,9000}; do
        ...
        mv "/home/meraslia/workspace_reco/nested_admm/data/Algo/diff_img.png" "/home/meraslia/Documents/Thèse/Résultats à montrer/2023_09_13/bias images ReLU exp/automatic/bias_img_Gong_3_3_"$num_epoch"it.png"
        # nested ADMM
        ...
        mv "/home/meraslia/workspace_reco/nested_admm/data/Algo/diff_img.png" "/home/meraslia/Documents/Thèse/Résultats à montrer/2023_09_13/bias images ReLU exp/automatic/bias_img_nested_3_3_"$num_epoch"it.png"
