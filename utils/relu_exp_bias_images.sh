for ((phantom_type=1;phantom_type<=1;phantom_type++)); do
    for num_epoch in {1000,4000,7500,9000}; do
        ...
        # mv "/home/meraslia/workspace_reco/nested_admm/data/Algo/diff_img.png" "/home/meraslia/Documents/Thèse/Résultats à montrer/2024_01_16/TMI_paper/relu_exp/bias_img_Gong_3_"$phantom_type"_"$num_epoch"it.png"
        ...
        mv "/home/meraslia/workspace_reco/nested_admm/data/Algo/diff_img.png" "/home/meraslia/Documents/Thèse/Résultats à montrer/2024_01_16/TMI_paper/relu_exp/bias_img_nested_3_"$phantom_type"_"$num_epoch"it.png"
