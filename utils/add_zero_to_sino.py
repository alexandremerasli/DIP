...
# sino_without_zero_CASToR = fijii_np(subroot + "/Data/database_v2/" + phantom + "/simu0_1/Ax_test.s",(68516,1))
...
# atn_img = 1/10*fijii_np(subroot + "/Data/database_v2/" + phantom + "/" + phantom + "_atn.img",PETImage_shape)
# save_img(atn_img,subroot + "/Data/database_v2/" + phantom + "/" + phantom + "_atn_divided_10.img")
...
# save_img(sino_full_ones,subroot + "/Data/database_v2/" + phantom + "/" + "sino_ones.s")
...
# save_img(syst_mat_disorder_np, subroot + "/final_syst_mat.img")
print("End")
