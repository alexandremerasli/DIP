...
ROI_MR_list = [tumor_1a_ROI]
ROI_PET_list = [tumor_1a_ROI]
tumor_MR_values_list = [1400]
tumor_PET_values_list = [10]
...
plt.show()
Path("data/Algo/Data/database_v2/image50_2").mkdir(parents=True, exist_ok=True)
save_img(img_PET,'data/Algo/Data/database_v2/image50_2/image50_2.raw')
save_img(img_MR,'data/Algo/Data/database_v2/image50_2/image50_2_mr.raw')