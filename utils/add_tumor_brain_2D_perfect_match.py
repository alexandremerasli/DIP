...
plt.show()
Path(subroot + "/Data/database_v2/image50_2").mkdir(parents=True, exist_ok=True)
save_img(img_PET,subroot + 'Data/database_v2/image50_2/image50_2.raw')
save_img(img_MR,subroot + 'Data/database_v2/image50_2/image50_2_mr.raw')