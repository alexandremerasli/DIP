...
class iPostReconstruction(vDenoising):
    ...
    def runComputation(self,config,root):
        ...
        model.initialize_MV(config,self.param1_scale_im_corrupt,self.param2_scale_im_corrupt,self.scaling_input,self.suffix,self.global_it,self.sub_iter_DIP,self.root, self.subroot,self.scanner, self.simulation, self.hyperparameters_list)
