...
hyperparameters_config = {
    ...
    "scaling" : tune.grid_search(['standardization','positive_normalization','normalization']), # Pre processing of neural network input (nothing, uniform, normalization, standardization)
    ...
    "nb_outer_iteration": tune.grid_search([3,30]), # Number of outer iterations in ADMMLim (and nested) and OPTITR (for Gong)
