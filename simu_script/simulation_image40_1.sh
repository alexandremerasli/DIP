...
for ((replicate_id=1;replicate_id<=nb_replicates;replicate_id++)); do
    ...
    ################################################################################################
    mkdir -p ../data/Algo/Data/database_v2/image40_1

    # Copying previously computed masks 
    #cp -nr ../data/Algo/Data/database_v2/image40_1_1replicate/* ../data/Algo/Data/database_v2/image40_1

    # Copying phantoms
    #cp image40_1* ../data/Algo/Data/database_v2/image40_1
    cp image40_1.img ../data/Algo/Data/database_v2/image40_1/image40_1.raw
    cp image40_1.hdr ../data/Algo/Data/database_v2/image40_1/image40_1.hdr
    cp image40_1_atn.img ../data/Algo/Data/database_v2/image40_1/image40_1_atn.raw
    cp image40_1_atn.hdr ../data/Algo/Data/database_v2/image40_1/image40_1_atn.hdr
    cp image40_1_mr.img ../data/Algo/Data/database_v2/image40_1/image40_1_mr.raw
    cp image40_1_mr.hdr ../data/Algo/Data/database_v2/image40_1/image40_1_mr.hdr
    # Copying datafile, cmap and sinograms
    cp -r data40_1_${replicate_id}/ ../data/Algo/Data/database_v2/image40_1
    cp -r cmap0/ ../data/Algo/Data/database_v2/image40_1
    cp -r simu0_${replicate_id}/ ../data/Algo/Data/database_v2/image40_1
done