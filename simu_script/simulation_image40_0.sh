...
create_phantom.exe -o image40_0 -d $dim1 $dim2 $dim3 -v 4. 4. 4. -c 0. 0. 0. 150. 4. 100 -c 50. 10. 0. 20. 4. 400 -c -40. -40. 0. 40. 4. 10. -c -20. 70. 0. 20. 4. 400 -c 50. 90. 0. 20. 4. 400 -x 32 32 1

# Create attenuation map
create_phantom.exe -o image40_0_atn -d $dim1 $dim2 $dim3 -v 4. 4. 4. -c 0. 0. 0. 150. 4. 0.096 -x 32 32 1

# Create DIP input map (idea : similar to MR)
create_phantom.exe -o image40_0_mr -d $dim1 $dim2 $dim3 -v 4. 4. 4. -c 0. 0. 0. 150. 4. 30 -c -40. -40. 0. 40. 4. 60. -b -20. 80. 0. 40. 40. 4. 60 -e 40. -90. 0. 20. 40. 4. 60 -c 50. 90. 0. 20. 4. 60 -x 32 32 1
...
for ((replicate_id=1;replicate_id<=nb_replicates;replicate_id++)); do
    ...
    simulator.exe -m biograph2D -c biograph/biograph.ecm -i image40_0.hdr -a image40_0_atn.hdr -r $random_fraction -s 0.35 -p 4 -P $nb_counts -D -v 2 -o simulation1 -T 4
    ...
    SMprojector.exe -m mmr2d -c cmap0/cmap0.ecm -i image40_0.hdr -a image40_0_atn.hdr -s 0.35 -r $random_fraction -l 0.8 -p 4. -v 5 -P $nb_counts -o simu0_${replicate_id} -D
    ...
    SMmaker.exe -m mmr2d -o data40_0_${replicate_id} -p simu0_${replicate_id}/simu0_${replicate_id}_pt.s.hdr -r simu0_${replicate_id}/simu0_${replicate_id}_rd.s.hdr -s simu0_${replicate_id}/simu0_${replicate_id}_sc.s.hdr -n simu0_${replicate_id}/simu0_${replicate_id}_nm.s.hdr -A simu0_${replicate_id}/simu0_${replicate_id}_at.s -c cmap0/cmap0.ecm -castor -v 2
    ...
    ################################################################################################
    mkdir -p ../../data/Algo/Data/database_v2/image40_0

    # Copying previously computed masks 
    #cp -nr ../../data/Algo/Data/database_v2/image40_0_1replicate/* ../../data/Algo/Data/database_v2/image40_0

    # Copying phantoms
    #cp image40_0* ../../data/Algo/Data/database_v2/image40_0
    cp image40_0.img ../../data/Algo/Data/database_v2/image40_0/image40_0.raw
    cp image40_0.hdr ../../data/Algo/Data/database_v2/image40_0/image40_0.hdr
    cp image40_0_atn.img ../../data/Algo/Data/database_v2/image40_0/image40_0_atn.raw
    cp image40_0_atn.hdr ../../data/Algo/Data/database_v2/image40_0/image40_0_atn.hdr
    cp image40_0_mr.img ../../data/Algo/Data/database_v2/image40_0/image40_0_mr.raw
    cp image40_0_mr.hdr ../../data/Algo/Data/database_v2/image40_0/image40_0_mr.hdr
    # Copying datafile, cmap and sinograms
    cp -r data40_0_${replicate_id}/ ../../data/Algo/Data/database_v2/image40_0
    cp -r cmap0/ ../../data/Algo/Data/database_v2/image40_0
    cp -r simu0_${replicate_id}/ ../../data/Algo/Data/database_v2/image40_0
done