...
nb_counts=500000 # FDG TMI low statistics
echo $nb_counts
random_fraction=0.4 # FDG random fraction

# Choosing directory to work on
mkdir -p simu_script/simu_mmr_low_count
cd simu_script/simu_mmr_low_count
...
for ((replicate_id=1;replicate_id<=nb_replicates;replicate_id++)); do
    ...
    SMprojector.exe -m mmr2d -c cmap0/cmap0.ecm -i image50_2_10.hdr -a image50_2_10_atn.hdr -s 0.35 -r $random_fraction -l 0.01 -p 4. -v 5 -P $nb_counts -o simu0_${replicate_id} -D
    ...
    SMmaker.exe -m mmr2d -o data50_2_10_${replicate_id} -p simu0_${replicate_id}/simu0_${replicate_id}_pt.s.hdr -r simu0_${replicate_id}/simu0_${replicate_id}_rd.s.hdr -s simu0_${replicate_id}/simu0_${replicate_id}_sc.s.hdr -n simu0_${replicate_id}/simu0_${replicate_id}_nm.s.hdr -A simu0_${replicate_id}/simu0_${replicate_id}_at.s -c cmap0/cmap0.ecm -castor -v 2


    ###############################################################################################
    ##	Copy to DIP used directories
    ################################################################################################
    mkdir -p ../../data/Algo/Data/database_v2/image50_2_10

    # Copying previously computed masks 
    #cp -nr ../../data/Algo/Data/database_v2/image50_2_10_1replicate/* ../../data/Algo/Data/database_v2/image50_2_10

    # Copying phantoms
    #cp image50_2_10* ../../data/Algo/Data/database_v2/image50_2_10
    cp image50_2_10.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10.raw
    cp image50_2_10.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10.img
    cp image50_2_10.hdr ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10.hdr
    cp image50_2_10_atn.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_atn.raw
    cp image50_2_10_atn.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_atn.img
    cp image50_2_10_atn.hdr ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_atn.hdr
    cp image50_2_10_mr.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_mr.raw
    cp image50_2_10_mr.img ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_mr.img
    cp image50_2_10_mr.hdr ../../data/Algo/Data/database_v2/image50_2_10/image50_2_10_mr.hdr
    # Copying datafile, cmap and sinograms
    cp -r data50_2_10_${replicate_id}/ ../../data/Algo/Data/database_v2/image50_2_10
    cp -r cmap0/ ../../data/Algo/Data/database_v2/image50_2_10
    cp -r simu0_${replicate_id}/ ../../data/Algo/Data/database_v2/image50_2_10
done