...
mkdir -p simu_script/simu_mmr_sans_shuffle_brain
cd simu_script/simu_mmr_sans_shuffle_brain
...
for ((replicate_id=1;replicate_id<=nb_replicates;replicate_id++)); do
    ...
    SMprojector.exe -m mmr2d -c cmap0/cmap0.ecm -i image50_20.hdr -a image50_20_atn.hdr -s 0.35 -r $random_fraction -l 0.01 -p 4. -v 5 -P $nb_counts -o simu0_${replicate_id} -D
    ...
    SMmaker.exe -m mmr2d -o data50_20_${replicate_id} -p simu0_${replicate_id}/simu0_${replicate_id}_pt.s.hdr -r simu0_${replicate_id}/simu0_${replicate_id}_rd.s.hdr -s simu0_${replicate_id}/simu0_${replicate_id}_sc.s.hdr -n simu0_${replicate_id}/simu0_${replicate_id}_nm.s.hdr -A simu0_${replicate_id}/simu0_${replicate_id}_at.s -c cmap0/cmap0.ecm -castor -v 2


    ###############################################################################################
    ##	Copy to DIP used directories
    ################################################################################################
    mkdir -p ../../data/Algo/Data/database_v2/image50_20

    # Copying previously computed masks 
    #cp -nr ../../data/Algo/Data/database_v2/image50_20_1replicate/* ../../data/Algo/Data/database_v2/image50_20

    # Copying phantoms
    #cp image50_20* ../../data/Algo/Data/database_v2/image50_20
    cp image50_20.img ../../data/Algo/Data/database_v2/image50_20/image50_20.raw
    cp image50_20.hdr ../../data/Algo/Data/database_v2/image50_20/image50_20.hdr
    cp image50_20_atn.img ../../data/Algo/Data/database_v2/image50_20/image50_20_atn.raw
    cp image50_20_atn.hdr ../../data/Algo/Data/database_v2/image50_20/image50_20_atn.hdr
    cp image50_20_mr.img ../../data/Algo/Data/database_v2/image50_20/image50_20_mr.raw
    cp image50_20_mr.hdr ../../data/Algo/Data/database_v2/image50_20/image50_20_mr.hdr
    # Copying datafile, cmap and sinograms
    cp -r data50_20_${replicate_id}/ ../../data/Algo/Data/database_v2/image50_20
    cp -r cmap0/ ../../data/Algo/Data/database_v2/image50_20
    cp -r simu0_${replicate_id}/ ../../data/Algo/Data/database_v2/image50_20
done